#par(mfcol=c(4,3), mar=c(4.5,4.5,2,0.5), oma=c(0,0,0,0))

png(file="plot100.png",width=600,height=600)
par(mfcol=c(4,3), mar=c(4.5,4.5,2,0.5), oma=c(0,0,0,0))
...
dev.off()
png(file="plot400.png",width=600,height=600)
par(mfcol=c(4,3), mar=c(4.5,4.5,2,0.5), oma=c(0,0,0,0))
...
dev.off()
png(file="plot2000.png",width=600,height=600)
par(mfcol=c(4,3), mar=c(4.5,4.5,2,0.5), oma=c(0,0,0,0))
...
dev.off()
png(file="plot10000.png",width=600,height=600)
par(mfcol=c(4,3), mar=c(4.5,4.5,2,0.5), oma=c(0,0,0,0))
